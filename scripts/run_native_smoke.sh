...
SCRATCH="${MILESTRO_SCRATCH:-/var/folders/jr/1y3p6lzn4l57k1lt5_scws080000gq/T/grok-goal-0f54ea36b802/implementer}"
...
if [[ ! -x "$BIN" ]]; then
  ...
  cmake -S "$ROOT/native_smoke" -B "$ROOT/native_smoke/build" -G Ninja -DCMAKE_BUILD_TYPE=Release
